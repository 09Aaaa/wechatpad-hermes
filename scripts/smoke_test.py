...
def main() -> None:
    ...
    try:
        ...
        assert_true("_redacted_secret_field_count" in safe_cache_text, "structured redaction should summarize removed secret fields")
        ...
        assert_true("Pwd" not in safe_cache_text and "Aeskey" not in safe_cache_text and "Sessionkey" not in safe_cache_text, "structured redaction should remove secret field names")
        ...
        assert_true("_redacted_secret_field_count" in owner_cache_result, "owner cache output should summarize redacted secret cache fields")
        assert_true(sample_authcode() not in owner_cache_result, "owner cache output should not expose cache authcodes")
        assert_true("CacheKey" not in owner_cache_result, "owner cache output should remove secret field names")
